        ...
        private async void GetLZNew(int order)
        {
            ...
            try
            {
                ...
                using (hc = new HttpClient())
                {
                    ...
                    {
                        case 0:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=22&page=" + PageNum_LZ + "&pagesize=50&order=default";
                            break;
                        case 1:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=22&page=" + PageNum_LZ + "&pagesize=50&order=damku";
                            break;
                        case 2:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=22&page=" + PageNum_LZ + "&pagesize=50&order=hot";
                            break;
                        case 3:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=22&page=" + PageNum_LZ + "&pagesize=50&order=review";
                            break;
                        case 4:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=22&page=" + PageNum_LZ + "&pagesize=50&order=stow";
                            break;
                        default:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=22&page=" + PageNum_LZ + "&pagesize=50&order=default";
                            break;
        ...
        private async void GetWJList(int order)
        {
            ...
            try
            {
                ...
                using (hc = new HttpClient())
                {
                    ...
                    {
                        case 0:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=26&page=" + PageNum_WJ + "&pagesize=50&order=default";
                            break;
                        case 1:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=26&page=" + PageNum_WJ + "&pagesize=50&order=damku";
                            break;
                        case 2:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=26&page=" + PageNum_WJ + "&pagesize=50&order=hot";
                            break;
                        case 3:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=26&page=" + PageNum_WJ + "&pagesize=50&order=review";
                            break;
                        case 4:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=26&page=" + PageNum_WJ + "&pagesize=50&order=stow";
                            break;
                        default:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=26&page=" + PageNum_WJ + "&pagesize=50&order=default";
                            break;
        ...
        private async void GetGCList(int order)
        {
            ...
            try
            {
                ...
                using (hc = new HttpClient())
                {
                    ...
                    {
                        case 0:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=126&page=" + PageNum_GC + "&pagesize=50&order=default";
                            break;
                        case 1:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=126&page=" + PageNum_GC + "&pagesize=50&order=damku";
                            break;
                        case 2:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=126&page=" + PageNum_GC + "&pagesize=50&order=hot";
                            break;
                        case 3:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=126&page=" + PageNum_GC + "&pagesize=50&order=review";
                            break;
                        case 4:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=126&page=" + PageNum_GC + "&pagesize=50&order=stow";
                            break;
                        default:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=126&page=" + PageNum_GC + "&pagesize=50&order=default";
                            break;
        ...
        private async void GetZXList(int order)
        {
            ...
            try
            {
                ...
                using (hc = new HttpClient())
                {
                    ...
                    {
                        case 0:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=127&page=" + PageNum_ZX + "&pagesize=50&order=default";
                            break;
                        case 1:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=127&page=" + PageNum_ZX + "&pagesize=50&order=damku";
                            break;
                        case 2:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=127&page=" + PageNum_ZX + "&pagesize=50&order=hot";
                            break;
                        case 3:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=127&page=" + PageNum_ZX + "&pagesize=50&order=review";
                            break;
                        case 4:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=127&page=" + PageNum_ZX + "&pagesize=50&order=stow";
                            break;
                        default:
                            uri = "http://api.bilibili.com/list?type=json&appkey=1d8b6e7d45233436&tid=127&page=" + PageNum_ZX + "&pagesize=50&order=default";
                            break;

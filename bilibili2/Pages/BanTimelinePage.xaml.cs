        ...
        public async void GetBangumiTimeLine()
        {
            try
            {
               ...
               WebClientClass  wc = new WebClientClass();
                var url = $"https://bangumi.bilibili.com/api/timeline_v4?_device=android&_ulv=10000&build=434000&platform=android&appkey=84956560bc028eb7&area_id=1{Uri.EscapeDataString(",")}2{Uri.EscapeDataString(",")}-1";

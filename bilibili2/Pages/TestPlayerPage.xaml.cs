        ...
        public async void GetPlayInfo(string mid, int quality)
        {
            ...
            try
            {
                WebClientClass wc = new WebClientClass();
                    string results = await wc.GetResults(new Uri("http://interface.bilibili.com/playurl?platform=android&cid=" + mid + "&quality=" + 2 + "&otype=json&appkey=84956560bc028eb7&type=mp4"));
